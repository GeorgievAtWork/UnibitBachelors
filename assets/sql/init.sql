...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2022 at 04:14 AM
...
INSERT INTO `subjects` (`subject_id`, `subject_name`, `tutor_id`) VALUES
(1, 'Лайфстайл', 1),
(2, 'Фотография', 1),
(3, 'Информационни технологии', 2),
(4, 'Финанси', 2),
(5, 'Фитнес и тренировки', 3),
(6, 'Науки', 3);
