    ...
    <div class="container">
        <div class="row ">
            <div class="col-md-12 ">
                <p class="about-text" data-aos="fade-up" data-aos-duration="750" data-aos-delay="150">
                    ...
                    Всеки може да се възползва от съдържанието, предлагано напълно безплатно от преподаватели в областта.
        ...
        <div class="row img-container">
            ...
            <div class="col-md-4">
                ...
                <span class="caption" data-aos="fade-left" data-aos-delay="900" data-aos-duration="750" data-aos-anchor="#oval-img-3">Придобий нови знания и се сертифицирай</span>
            </div>
        </div>
    </div>
</section>
